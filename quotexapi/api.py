...
class QuotexAPI(object):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, host, set_ssid):
        ...
        """
        self.profile = None
        self.wss_url = "wss://ws2.{host}/socket.io/?EIO=3&transport=websocket".format(host=host)
    ...
    def send_websocket_request(self, data):
        ...
        while (
                global_value.ssl_Mutual_exclusion or global_value.ssl_Mutual_exclusion_write) and global_value.no_force_send:
            pass
